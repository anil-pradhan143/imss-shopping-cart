...
const getOrgHierarchy = (payBeneficiary, acc) => {
 ...
 var result=payBeneficiaries.map((pb) => ({
 ...
 setOutput(result);
    ...
    return (
        <>
         <div style={{ padding:'10px',background:'#fff',marginBottom:'20px',textAlign:'center'}}><h2>BeneficiaryPayId and parentBenePayId parent children relationship output</h2></div>
         <ProductList>
